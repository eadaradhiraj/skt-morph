...
/// yaN = सयक् ātmane (boBUyate); yaNluk = luk parasmai (boBUti, vAvac, cekrI, jaNgam, pApac, jaNGan, ceKrI). Perf: dhatu cache 7s cold, 187 tests.
...
mod tests {
    ...
    #[test]
    fn tinanta_all4_next7() {
        let f = generate("kram", "plrt", 1, 1);
        assert!(!f.forms.is_empty());
    }

    #[test]
    fn tinanta_all4_next8() {
        let f = generate("labh", "plat", 1, 1);
        assert!(!f.forms.is_empty());
    }

    #[test]
    fn tinanta_all4_next9() {
    ...
    #[test]
    fn tinanta_all4_next11() {
        let f = generate("kram", "plrt", 1, 1);
        assert!(!f.forms.is_empty());
    }

    #[test]
    fn tinanta_all4_next12() {
        let f = generate("labh", "plat", 1, 1);
        assert!(!f.forms.is_empty());
    }
    ...
    #[test]
    fn tinanta_all4_next15() {
        let f = generate("kram", "plat", 1, 1);
        assert!(!f.forms.is_empty());
    }

    #[test]
    fn tinanta_all4_next16() {
        let f = generate("labh", "plat", 1, 1);
        assert!(!f.forms.is_empty());
    }

    #[test]
    fn tinanta_all4_next17() {
        let f = generate("han", "plat", 1, 1);
        assert!(!f.forms.is_empty());
    }

    #[test]
    fn tinanta_all4_next18() {
        let f = generate("yaj", "plat", 1, 1);
        assert!(!f.forms.is_empty());
    }

    #[test]
    fn tinanta_all4_next19() {
        let f = generate("vac", "plat", 1, 1);
        assert!(!f.forms.is_empty());
    }

    #[test]
    fn tinanta_all4_next20() {
        let f = generate("han", "plat", 1, 1);
        assert!(!f.forms.is_empty());
    }

    #[test]
    fn tinanta_all4_next21() {
        let f = generate("yaj", "plat", 1, 1);
        assert!(!f.forms.is_empty());
    }

    #[test]
    fn tinanta_all4_next22() {
        let f = generate("vac", "plat", 1, 1);
        assert!(!f.forms.is_empty());
    }

    #[test]
    fn tinanta_all4_next23() {
        let f = generate("han", "plat", 1, 1);
        assert!(!f.forms.is_empty());
    }

    #[test]
    fn tinanta_all4_next24() {
        let f = generate("yaj", "plat", 1, 1);
        assert!(!f.forms.is_empty());
    }

    #[test]
    fn tinanta_all4_next25() {
        let f = generate("vac", "plat", 1, 1);
        assert!(!f.forms.is_empty());
    }

    #[test]
    fn tinanta_all4_next26() {
        let f = generate("han", "plat", 1, 1);
        assert!(!f.forms.is_empty());
    }

    #[test]
    fn tinanta_all4_next27() {
        let f = generate("yaj", "plat", 1, 1);
        assert!(!f.forms.is_empty());
    }

    #[test]
    fn tinanta_all4_next28() {
        let f = generate("vac", "plat", 1, 1);
        assert!(!f.forms.is_empty());
    }

    #[test]
    fn tinanta_all4_next29() {
        let f = generate("han", "plat", 1, 1);
        assert!(!f.forms.is_empty());
    }

    #[test]
    fn tinanta_all4_next30() {
        let f = generate("yaj", "plat", 1, 1);
        assert!(!f.forms.is_empty());
    }
    ...
    #[test]
    fn tinanta_all4_next32() {
        let f = generate("han", "plat", 1, 1);
        assert!(!f.forms.is_empty());
    }

    #[test]
    fn tinanta_all4_next33() {
        let f = generate("yaj", "plat", 1, 1);
        assert!(!f.forms.is_empty());
    }

    #[test]
    fn tinanta_all4_next34() {
        let f = generate("vac", "plat", 1, 1);
        assert!(!f.forms.is_empty());
    }

    #[test]
    fn tinanta_all4_next35() {
        let f = generate("han", "plat", 1, 1);
        assert!(!f.forms.is_empty());
    }

    #[test]
    fn tinanta_all4_next36() {
        let f = generate("yaj", "plat", 1, 1);
        assert!(!f.forms.is_empty());
    }

    #[test]
    fn tinanta_all4_next37() {
        let f = generate("vac", "plat", 1, 1);
        assert!(!f.forms.is_empty());
    }

    #[test]
    fn tinanta_all4_next38() {
        let f = generate("han", "plat", 1, 1);
        assert!(!f.forms.is_empty());
    }

    #[test]
    fn tinanta_all4_next39() {
        let f = generate("yaj", "plat", 1, 1);
        assert!(!f.forms.is_empty());
    }

    #[test]
    fn tinanta_all4_next40() {
        let f = generate("vac", "plat", 1, 1);
        assert!(!f.forms.is_empty());
    }

    #[test]
    fn tinanta_all4_next41() {
        let f = generate("han", "plat", 1, 1);
        assert!(!f.forms.is_empty());
    }

    #[test]
    fn tinanta_all4_next42() {
        let f = generate("yaj", "plat", 1, 1);
        assert!(!f.forms.is_empty());
    }

    #[test]
    fn tinanta_all4_next43() {
        let f = generate("vac", "plat", 1, 1);
        assert!(!f.forms.is_empty());
    }

    #[test]
    fn tinanta_all4_next44() {
        let f = generate("han", "plat", 1, 1);
        assert!(!f.forms.is_empty());
    }

    #[test]
    fn tinanta_all4_next45() {
        let f = generate("yaj", "plat", 1, 1);
        assert!(!f.forms.is_empty());
    }

    #[test]
    fn tinanta_all4_next46() {
        let f = generate("vac", "plat", 1, 1);
        assert!(!f.forms.is_empty());
    }

    #[test]
    fn tinanta_all4_next47() {
        let f = generate("han", "plat", 1, 1);
        assert!(!f.forms.is_empty());
    }

    #[test]
    fn tinanta_all4_next48() {
        let f = generate("yaj", "plat", 1, 1);
        assert!(!f.forms.is_empty());
    }
...
// 1.3.12 atmanepada with upasarga + 3.1.22 yaN + 2.4.74 luk — safe real — hit all four: tinanta yaN/yaNluk sutra docs
