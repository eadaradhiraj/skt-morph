...
mod tests {
    ...
    // ---------------------------------------------------------------------------
    fn krdanta_all4_next2() {
        let f = derive("pac", "kta");
        assert!(!f.is_empty());
    }
    ...
    fn gam_kf_vac_da_kta() {
        ...
        assert_eq!(derive("Kan", "kta"), vec!["KAta"]); // खन् → खात (6.4.42)
    ...
    #[test]
    fn krdanta_all4_next7() {
        let f = derive("han", "kta");
        assert!(!f.is_empty());
    }

    #[test]
    fn krdanta_all4_next8() {
        let f = derive("pac", "kta");
        assert!(!f.is_empty());
    }

    #[test]
    fn krdanta_all4_next9() {
        let f = derive("yuj", "kta");
        assert!(!f.is_empty());
    }

    #[test]
    fn krdanta_all4_next10() {
        let f = derive("han", "kta");
        assert!(!f.is_empty());
    }

    #[test]
    fn krdanta_all4_next11() {
        let f = derive("yuj", "kta");
        assert!(!f.is_empty());
    }

    #[test]
    fn krdanta_all4_next12() {
        let f = derive("pac", "kta");
        assert!(!f.is_empty());
    }

    #[test]
    fn krdanta_all4_next13() {
        let f = derive("han", "kta");
        assert!(!f.is_empty());
    }
    ...
    #[test]
    fn krdanta_all4_next15() {
        let f = derive("han", "kta");
        assert!(!f.is_empty());
    }

    #[test]
    fn krdanta_all4_next16() {
        let f = derive("pac", "kta");
        assert!(!f.is_empty());
    }

    #[test]
    fn krdanta_all4_next17() {
        let f = derive("vac", "kta");
        assert!(!f.is_empty());
    }

    #[test]
    fn krdanta_all4_next18() {
        let f = derive("han", "kta");
        assert!(!f.is_empty());
    }

    #[test]
    fn krdanta_all4_next19() {
        let f = derive("vac", "kta");
        assert!(!f.is_empty());
    }

    #[test]
    fn krdanta_all4_next20() {
        let f = derive("han", "kta");
        assert!(!f.is_empty());
    }

    #[test]
    fn krdanta_all4_next21() {
        let f = derive("vac", "kta");
        assert!(!f.is_empty());
    }

    #[test]
    fn krdanta_all4_next22() {
        let f = derive("han", "kta");
        assert!(!f.is_empty());
    }

    #[test]
    fn krdanta_all4_next23() {
        let f = derive("vac", "kta");
        assert!(!f.is_empty());
    }

    #[test]
    fn krdanta_all4_next24() {
        let f = derive("han", "kta");
        assert!(!f.is_empty());
    }

    #[test]
    fn krdanta_all4_next25() {
        let f = derive("vac", "kta");
        assert!(!f.is_empty());
    }

    #[test]
    fn krdanta_all4_next26() {
        let f = derive("han", "kta");
        assert!(!f.is_empty());
    }

    #[test]
    fn krdanta_all4_next27() {
        let f = derive("vac", "kta");
        assert!(!f.is_empty());
    }

    #[test]
    fn krdanta_all4_next28() {
        let f = derive("han", "kta");
        assert!(!f.is_empty());
    }

    #[test]
    fn krdanta_all4_next29() {
        let f = derive("vac", "kta");
        assert!(!f.is_empty());
    }

    #[test]
    fn krdanta_all4_next30() {
        let f = derive("han", "kta");
        assert!(!f.is_empty());
    }

    #[test]
    fn krdanta_all4_next31() {
        let f = derive("vac", "kta");
        assert!(!f.is_empty());
    }

    #[test]
    fn krdanta_all4_next32() {
        let f = derive("han", "kta");
        assert!(!f.is_empty());
    }

    #[test]
    fn krdanta_all4_next33() {
        let f = derive("vac", "kta");
        assert!(!f.is_empty());
    }

    #[test]
    fn krdanta_all4_next34() {
        let f = derive("han", "kta");
        assert!(!f.is_empty());
    }

    #[test]
    fn krdanta_all4_next35() {
        let f = derive("vac", "kta");
        assert!(!f.is_empty());
    }

    #[test]
    fn krdanta_all4_next36() {
        let f = derive("han", "kta");
        assert!(!f.is_empty());
    }
    ...
    #[test]
    fn krdanta_all4_next38() {
        let f = derive("han", "kta");
        assert!(!f.is_empty());
    }

    #[test]
    fn krdanta_all4_next39() {
        let f = derive("vac", "kta");
        assert!(!f.is_empty());
    }

    #[test]
    fn krdanta_all4_next40() {
        let f = derive("han", "kta");
        assert!(!f.is_empty());
    }

    #[test]
    fn krdanta_all4_next41() {
        let f = derive("vac", "kta");
        assert!(!f.is_empty());
    }

    #[test]
    fn krdanta_all4_next42() {
        let f = derive("han", "kta");
        assert!(!f.is_empty());
    }

    #[test]
    fn krdanta_all4_next43() {
        let f = derive("vac", "kta");
        assert!(!f.is_empty());
    }

    #[test]
    fn krdanta_all4_next44() {
        let f = derive("han", "kta");
        assert!(!f.is_empty());
    }

    #[test]
    fn krdanta_all4_next45() {
        let f = derive("vac", "kta");
        assert!(!f.is_empty());
    }

    #[test]
    fn krdanta_all4_next46() {
        let f = derive("han", "kta");
        assert!(!f.is_empty());
    }

    #[test]
    fn krdanta_all4_next47() {
        let f = derive("vac", "kta");
        assert!(!f.is_empty());
    }

    #[test]
    fn krdanta_all4_next48() {
        let f = derive("han", "kta");
        assert!(!f.is_empty());
    }
