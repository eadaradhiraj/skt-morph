...
mod tests {
    ...
    fn subanta_8_2_30_c() {
        ...
        assert!(c.declension.get("prathamA").unwrap().iter().any(|x| x=="vAk"));
    }
    ...
    #[test]
    fn subanta_all4_next35() {
        let s = generate("rAjan", "pum").expect("rAjan");
        assert!(!s.declension.is_empty());
    }

    #[test]
    fn subanta_all4_next36() {
        let s = generate("pitf", "pum").expect("pitf");
        assert!(!s.declension.is_empty());
    }

    #[test]
    fn subanta_all4_next37() {
        let s = generate("go", "pum").expect("go");
        assert!(!s.declension.is_empty());
    }

    #[test]
    fn subanta_all4_next38() {
        let s = generate("rAjan", "pum").expect("rAjan");
        assert!(!s.declension.is_empty());
    }

    #[test]
    fn subanta_all4_next39() {
        let s = generate("pitf", "pum").expect("pitf");
        assert!(!s.declension.is_empty());
    }

    #[test]
    fn subanta_all4_next40() {
        let s = generate("go", "pum").expect("go");
        assert!(!s.declension.is_empty());
    }

    #[test]
    fn subanta_all4_next41() {
        let s = generate("rAjan", "pum").expect("rAjan");
        assert!(!s.declension.is_empty());
    }

    #[test]
    fn subanta_all4_next42() {
        let s = generate("pitf", "pum").expect("pitf");
        assert!(!s.declension.is_empty());
    }

    #[test]
    fn subanta_all4_next43() {
        let s = generate("go", "pum").expect("go");
        assert!(!s.declension.is_empty());
    }

    #[test]
    fn subanta_all4_next44() {
        let s = generate("rAjan", "pum").expect("rAjan");
        assert!(!s.declension.is_empty());
    }

    #[test]
    fn subanta_all4_next45() {
        let s = generate("pitf", "pum").expect("pitf");
        assert!(!s.declension.is_empty());
    }

    #[test]
    fn subanta_all4_next46() {
        let s = generate("go", "pum").expect("go");
        assert!(!s.declension.is_empty());
    }

    #[test]
    fn subanta_all4_next47() {
        let s = generate("rAjan", "pum").expect("rAjan");
        assert!(!s.declension.is_empty());
    }

    #[test]
    fn subanta_all4_next48() {
        let s = generate("pitf", "pum").expect("pitf");
        assert!(!s.declension.is_empty());
    }
