...
class TestEngineCorpusCoverage(unittest.TestCase):
    ...
    def test_coverage_complete(self):
        ...
        self.assertEqual(_g2_u_lat_join("yu", "mi", 3, 1), "yOmi")
        self.assertEqual(_g2_u_lat_join("ru", "si", 2, 1), "ravIzi")
        self.assertEqual(_g2_a_lat_join("snA", "TaH", 2, 2), "snATaH")
        self.assertEqual(_g2_a_lat_join("snA", "Ta", 2, 3), "snATa")
        self.assertEqual(_g2_u_lat_join("ru", "vaH", 3, 2), "ruvaH")
        self.assertIsNone(_g2_u_lat_join("ru", "xx", 1, 1))
        self.assertIsNone(_g2_u_lat_join("yu", "nti", 1, 3))
        self.assertEqual(_g2_ih_lat_join("duh", "maH", 3, 3), "duhmaH")
        self.assertEqual(_g2_ih_lat_join("duh", "anti", 1, 3), "duhanti")
